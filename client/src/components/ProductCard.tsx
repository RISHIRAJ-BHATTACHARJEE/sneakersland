...
const ProductCard = ({price, image, name}: Props) => {
  return (
    <div className="flex flex-col justify-between rounded-xl w-[162px] border border-zinc-400 drop-shadow-lg shadow-lg pb-1">
        <img
          src={image}
          alt="airorce-1"
          className="size-32 rounded-lg m-4 drop-shadow-lg shadow-lg"
        />
        <h2 className="font-semibold leading-5 pb-2 text-center">{name}</h2>
